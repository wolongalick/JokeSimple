 ...
 */
public class SGApiUtils4LvPi {
    private static SGApiUtils4LvPi ourInstance = new SGApiUtils4LvPi();
    ...
    public static SGApiUtils4LvPi getInstance() {
        return ourInstance;
    }

    private SGApiUtils4LvPi() {
        OkHttpClient.Builder builder = new OkHttpClient.Builder();
        builder.connectTimeout(DEFAULT_TIMEOUT, TimeUnit.SECONDS);
        interceptor = new SGHttpInterceptor(BLog.rootLogOn);
        builder.addInterceptor(interceptor);
        retrofit = new Retrofit.Builder()
                .baseUrl(BizContant.BASE_LVPi_URL)

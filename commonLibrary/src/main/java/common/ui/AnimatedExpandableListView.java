...
public class AnimatedExpandableListView extends ExpandableListView {
    ...
    public boolean collapseLastExpandedGroup(int currentClickGroupPosition) {
        if(currentClickGroupPosition!=lastExpandIndex && lastExpandIndex!=-1){
            return collapseGroupWithAnimation(lastExpandIndex);
        }
        return false;
    }
    public boolean collapseLastExpandedGroup() {

...
public class UriUtils {
     ...
     * @param context
     * @param localFilePath 本地文件路径,不可以是网络url
     * @return
     */
    public static Uri getUriCompatibleN(Context context, String localFilePath){
        return getUriCompatibleN(context,new File(localFilePath));
    }
     ...
     * @return
     */
    public static Uri parseRes2Uri(String packageName,int resId){

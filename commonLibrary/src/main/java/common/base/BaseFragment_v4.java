 ...
 */
public abstract class BaseFragment_v4<V extends MvpView,P extends MvpPresenter<V>> extends BasePermissionFragment_v4 implements IViewControl,IFragmentControl,IViewHelper,MvpView{
    private P presenter;
    private V view;
